/*
    ...
    Author: @iprxy
Version: 830712780
    Link: https://vk.com/js/snapster/mob_templates.js?830712780
    Last Update: 10.2.117
*/
var _templates = {
    header: function() {
        return '<a class="site_logo mob_site_logo icon-text_logo" href="/"></a><div class="head_menu_ic" onclick="siteHeader.userOver(this);"> <div class="head_menu_ic_lines"> <div class="head_menu_ic_line"></div> <div class="head_menu_ic_line"></div> <div class="head_menu_ic_line"></div> </div></div><div class="mob_head_menu" id="head_user_wrap"></div>';
    },
